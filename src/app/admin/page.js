...
const WA_MSG = {
  ...
  returned:         (name, num, items, total, paymentMethod, status) => `Dear *${name}*,\n\nWe hope you're doing well.\n\nUnfortunately, your order from *Secret Hour ${num}* has been returned to us because the delivery could not be completed.${fmtItems(items, total, paymentMethod, status)}\n\nWe sincerely apologise for any inconvenience caused. We understand that there may have been an issue with the courier reaching you, a missed call, or another unforeseen reason.\n\nIf you'd still like to receive your order, simply reply to this message and we'll be happy to arrange a re-delivery. If there was any issue during the delivery process, we'd really appreciate it if you could let us know so we can improve our service.\n\nWe're here to help and look forward to hearing from you. ❤️\n\n*Team Secret Hour*`,
};
