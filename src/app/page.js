  ...
  useEffect(() => {
    supabase
      ...
      .then(({ data }) => {
        ...
        // Card game for featured section (search by category, not slug)
  ...
  return (
    <div className="bg-sh-bg text-cream min-h-screen">
      ...
      <section className="relative min-h-screen px-4 md:px-6 overflow-hidden flex items-center bg-black">
        <Image src={IMG.silk} alt="Secret Hour" fill sizes="100vw" className="object-cover opacity-50 pointer-events-none" />
            ...
            return (
              <div className="relative aspect-square w-full overflow-hidden border border-gold-border/40 group">
                <Image
                  ...
                  alt="The Midnight Deck Secret Hour"
                  fill
      ...
      <section className="relative py-16 md:py-28 overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-40 pointer-events-none">
          <Image src={IMG.silk} alt="Secret Hour" fill className="object-cover" />
        </div>
