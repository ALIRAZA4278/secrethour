        ...
        <div>
          ...
          {coverImage ? (
            ...
            >
              ...
              <p className="text-gray-500 text-xs">Landscape • 1200×630px • JPG/PNG • Max 5MB</p>
            </div>
          )}
          ...
          <p className="text-gray-400 text-[11px] mt-2">Recommended: landscape · 1200×630px · JPG/PNG · max 5MB</p>
        </div>
